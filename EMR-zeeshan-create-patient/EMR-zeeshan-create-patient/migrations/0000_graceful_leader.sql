...
ALTER TABLE "clinic_faxes" ADD CONSTRAINT "clinic_faxes_sent_by_users_id_fk" FOREIGN KEY ("sent_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_access" ADD CONSTRAINT "user_access_module_operation_id_module_operations_id_fk" FOREIGN KEY ("module_operation_id") REFERENCES "public"."module_operations"("id") ON DELETE cascade ON UPDATE no action;